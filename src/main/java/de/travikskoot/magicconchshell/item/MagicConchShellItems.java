...
public class MagicConchShellItems {
    ...
    public static final Item NASTY_PATTY = registerItem("nasty_patty",
            properties -> new Item(properties.food(((new FoodProperties.Builder()).nutrition(4).saturationModifier(0.1F).build()), defaultFood().onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.8F)).build())));
